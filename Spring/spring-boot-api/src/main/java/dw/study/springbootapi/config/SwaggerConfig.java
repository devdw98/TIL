...
public class SwaggerConfig {
    ...
    public Docket swaggerApi(){
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(swaggerInfo()).select()
                .apis(RequestHandlerSelectors.basePackage("dw.study.springbootapi.controller")) //패키지 안의 controller내용을 읽어 mapping 된 resources들을 문서화
                .paths(PathSelectors.ant("/v1/**")) //v1로 시작하는 resources만 문서화
                .build()
